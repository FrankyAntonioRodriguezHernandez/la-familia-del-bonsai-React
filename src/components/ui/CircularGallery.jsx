  ...
  if (!effectiveUrl) {
    if (document.fonts && document.fonts.load) {
      try {
        ...
        // The browser will use its normal font fallback.
      }
    }
    return font;
  }
  ...
  try {
    ...
    if (document.fonts && document.fonts.load) {
      try {
        ...
        // Keep rendering with the requested family if the readiness check fails.
      }
    }
...
export default function CircularGallery({
  ...
  return (
    <div
      className="h-full w-full cursor-grab overflow-hidden active:cursor-grabbing focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-emerald-600"
      tabIndex={0}
      role="region"
      aria-label="Galeria circular de imagenes. Usa las flechas izquierda y derecha para navegar."
      ref={containerRef}
    />
  );
}

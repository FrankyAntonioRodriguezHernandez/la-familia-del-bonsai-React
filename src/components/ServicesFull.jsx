...
const ServicesFull = () => {
  const allServices = [
    ...
    // Agrega aquí TODOS tus servicios adicionales
    {
      ...
      image: require('../assets/Services/Poda1.jpg'), // Cambia por imagen real
      path: "/cuidado-profesional"
    },
    {
      title: "Talleres educativos",
      description: "Aprende el arte del bonsai con expertos",
      image: require('../assets/Services/Arrendamiento1.jpg'), // Cambia por imagen real
      path: "/talleres"
    }
  ];
